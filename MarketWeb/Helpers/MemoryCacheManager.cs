...
namespace MarketWeb.Helpers
{
    ...
    public partial class MemoryCacheManager : ICacheManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual ConcurrentDictionary<string, bool> GetCacheList()
        {
            return _allKeys;
        }
    ...
    public interface ICacheManager : IDisposable
    {
        ...
        /// </summary>
        /// <returns></returns>
        ConcurrentDictionary<string, bool> GetCacheList();
    }
}
